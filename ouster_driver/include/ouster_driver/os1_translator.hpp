...
public:
  ...
  static constexpr uint16_t NUM_POINTS_PER_BLOCK = 64U;   //64U OS2
  /// Length of an array of the sensor response on "get_beam_intrinsics"
  static constexpr uint16_t LENGTH_BEAM_INTRINSICS = 64U;   //64U OS2
...
private:
  ...
  static_assert(sizeof(DataBlock) == 788U, "Error OS1 data block size is incorrect");   // 1556U 788U OS2 
